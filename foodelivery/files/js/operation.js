...
var str_checkout_buttons='<a href="javascript:ProceedUpdate()" class="btn btn-xs btn-default add-right-margin">Обновить</a> <a href="javascript:GoToPayment()" type="button" class="btn btn-xs btn-info">Заказать</a>';
...
function UpdateCart()
{
	...
	if(cart_products.length>0)
	{
		...
		cart_html += '<span class="pull-right">Итого: '+currency_symbol+subtotal+'</span>';
...
{
	ShowPopup('<img src="files/images/loading.gif" alt="loading"/> Пожалуйста подождите');
